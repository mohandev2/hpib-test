...
#ifndef __MISMATCH_H__
#define __MISMATCH_H__
...
{
    class Mismatch : public AnnunciatorTestCase
    {
    public:
        Mismatch(char *line);
    ...
    private:
        HpiTestStatus testMismatch(SaHpiSessionIdT sessionId,
                                   SaHpiResourceIdT resourceId,
                                   SaHpiAnnunciatorNumT annunNum);

        HpiTestStatus prepAndTestMismatch(SaHpiSessionIdT sessionId,
                                          SaHpiResourceIdT resourceId,
                                          SaHpiAnnunciatorRecT * annunRec);
    };
}
