...
#ifndef __NORDRCAPABILITY_H__
#define __NORDRCAPABILITY_H__

#include "SafTest.h"
#include "HpiResourceTestCase.h"

/*****************************************************************************
 * No RDR Capability Test Case
 *****************************************************************************/

namespace ns_saHpiRdrGetByInstrumentId
{
    class NoRdrCapability : public HpiResourceTestCase
    {
    public:
        NoRdrCapability(char *line);
