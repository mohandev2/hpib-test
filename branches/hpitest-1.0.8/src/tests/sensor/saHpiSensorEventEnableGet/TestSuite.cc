...
TestSuite::TestSuite() {
    add(new GetEventEnableStatus("P87-16:P87-16"));
    add(new NoCapability("P87-17:P87-18"));
    add(new NullSensorEventsEnabled("P87-19:P87-19"));
    add(new SensorNotPresent("P87-20:P87-20"));
