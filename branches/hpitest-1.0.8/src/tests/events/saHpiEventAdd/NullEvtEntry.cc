...
NullEvtEntry::NullEvtEntry(char *line) : HpiSessionTestCase(line) {
}
...
HpiTestStatus NullEvtEntry::runSessionTest(SaHpiSessionIdT sessionId) {
    HpiTestStatus status;

    SaErrorT error = saHpiEventAdd(sessionId, NULL);
