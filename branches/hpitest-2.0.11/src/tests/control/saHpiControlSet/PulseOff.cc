...
PulseOff::PulseOff(char *line) : ControlTestCase(line) {
}
...
const char *PulseOff::getDescription() {
    return "Send SAHPI_CTRL_STATE_PULSE_OFF to a digital control which is OFF.";
}
...
const char *PulseOff::getPrecondition() {
...
SaErrorT PulseOff::getExpectedReturn() {
...
HpiTestStatus PulseOff::runCtrlTest(SaHpiSessionIdT sessionId,
