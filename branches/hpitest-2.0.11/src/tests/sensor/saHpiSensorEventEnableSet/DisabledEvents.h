...
#ifndef __DISABLEDEVENTS_H__
#define __DISABLEDEVENTS_H__
...
/*****************************************************************************
 * Disabled Events Test Case
 *****************************************************************************/

namespace ns_saHpiSensorEventEnableSet
{
    class DisabledEvents : public HpiSessionTestCase, public EventHandler
    {
    private:
        typedef struct {
