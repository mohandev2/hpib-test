...
#ifndef __INVALIDTIMERUSE_H__
#define __INVALIDTIMERUSE_H__

#include "WatchdogTestCase.h"

/*****************************************************************************
 * Invalid TimerUse Test Case
 *****************************************************************************/

namespace ns_saHpiWatchdogTimerSet
{
    class InvalidTimerUse : public WatchdogTestCase
    {
    public:
        InvalidTimerUse(char *line);
