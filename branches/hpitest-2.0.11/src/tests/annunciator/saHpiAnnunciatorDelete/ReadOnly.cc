...
const char *ReadOnly::getDescription() {
    return "The Annunciator is in AUTO mode and "
           "thus announcements cannot be deleted.";
}
...
const char *ReadOnly::getPrecondition() {
    return "Requires an Annunciator that is in AUTO mode or can\n"
 ...
 * Run the test.
 *
 * Attempt to delete all informational announcements from a read only
 * annunciator.
 *****************************************************************************/
