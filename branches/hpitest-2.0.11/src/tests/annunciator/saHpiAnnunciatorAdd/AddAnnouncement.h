...
#ifndef __ADDANNOUNCEMENT_H__
#define __ADDANNOUNCEMENT_H__

#include "AnnunciatorTestCase.h"

/*****************************************************************************
 * Add Announcement Test Case
 *****************************************************************************/

namespace ns_saHpiAnnunciatorAdd
{
    class AddAnnouncement : public AnnunciatorTestCase
    {
    public:
        AddAnnouncement(char *line);
