...
#ifndef __INVALIDRDRTYPE_H__
#define __INVALIDRDRTYPE_H__

#include "SafTest.h"
#include "HpiResourceTestCase.h"

/*****************************************************************************
 * Invalid RdrType Test Case
 *****************************************************************************/

namespace ns_saHpiRdrGetByInstrumentId
{
    class InvalidRdrType : public HpiResourceTestCase
    {
    public:
        InvalidRdrType(char *line);
