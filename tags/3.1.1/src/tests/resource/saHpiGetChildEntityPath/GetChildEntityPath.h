...
#ifndef __GETCHILDENTITYPATH_H__
#define __GETCHILDENTITYPATH_H__
...
{
    class GetChildEntityPath : public HpiSessionTestCase
    {
    public:
        GetChildEntityPath(char *line);
        ...
        HpiTestStatus parseDomainEntTree(SaHpiSessionIdT sessionId, 
