...
#ifndef __NOMOREENTRIES_H__
#define __NOMOREENTRIES_H__

#include "SafTest.h"
#include "NonEmptyEventLogTestCase.h"

/*****************************************************************************
 * No More Entries Test Case
 *****************************************************************************/

namespace ns_saHpiEventLogEntryGet
{
    class NoMoreEntries : public NonEmptyEventLogTestCase
    {
    public:
        NoMoreEntries(char *line);
