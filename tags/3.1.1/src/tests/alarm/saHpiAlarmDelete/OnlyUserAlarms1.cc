...
OnlyUserAlarms1::OnlyUserAlarms1(char *line) : HpiSessionTestCase(line) {
}
...
const char *OnlyUserAlarms1::getName() {
    return "OnlyUserAlarms1";
}
...
const char *OnlyUserAlarms1::getDescription() {
    return "When deleting alarms by severity, only User Alarms\n"
           "of the requested severity will be deleted.  A specific\n"
           "severity (CRITICAL, MAJOR, or MINOR) will be used.";
}
...
const char *OnlyUserAlarms1::getPrecondition() {
...
SaErrorT OnlyUserAlarms1::getExpectedReturn() {
    return SA_OK;
}
...
HpiTestStatus OnlyUserAlarms1::runSessionTest(SaHpiSessionIdT sessionId) {
 ...
 * by severity.  Only the user alarm should be deleted.  The system alarm
 * should still be in the DAT.
 *****************************************************************************/

HpiTestStatus OnlyUserAlarms1::deleteBySeverityTest(SaHpiSessionIdT sessionId,
                                                    SaHpiAlarmT systemAlarm) {
    HpiTestStatus status;
