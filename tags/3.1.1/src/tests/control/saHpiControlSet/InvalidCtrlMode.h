...
#ifndef __INVALIDCTRLMODE_H__
#define __INVALIDCTRLMODE_H__

#include "SafTest.h"
#include "ControlTestCase.h"

/*****************************************************************************
 * Invalid CtrlMode Test Case
 *****************************************************************************/

namespace ns_saHpiControlSet
{
    class InvalidCtrlMode : public ControlTestCase
    {
    public:
        InvalidCtrlMode(char *line);
