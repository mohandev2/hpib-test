...
#ifndef __SETANALOG_H__
#define __SETANALOG_H__

#include "SafTest.h"
#include "ControlTestCase.h"

/*****************************************************************************
 * Set Analog Test Case
 *****************************************************************************/

namespace ns_saHpiControlSet
{
    class SetAnalog : public ControlTestCase
    {
    public:
        SetAnalog(char *line);
    ...
    private:
        HpiTestStatus setAnalogValue(SaHpiSessionIdT sessionId,
