...
#ifndef __GENERATEUPMINOREVENT_H__
#define __GENERATEUPMINOREVENT_H__
...
namespace ns_saHpiSensorFunctional
{
    class GenerateUpMinorEvent : public HpiSessionTestCase, public EventHandler
    {
    private:
        typedef struct {
            UpMinorEventGenerator *upMinorEventGenerator;
            bool foundAssertEvent;
            bool foundDeassertEvent;
        } SensorData;
    ...
    public:
        GenerateUpMinorEvent(char *line);
