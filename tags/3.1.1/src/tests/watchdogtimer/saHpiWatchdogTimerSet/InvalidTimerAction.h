...
#ifndef __INVALIDTIMERACTION_H__
#define __INVALIDTIMERACTION_H__

#include "WatchdogTestCase.h"

/*****************************************************************************
 * Invalid TimerAction Test Case
 *****************************************************************************/

namespace ns_saHpiWatchdogTimerSet
{
    class InvalidTimerAction : public WatchdogTestCase
    {
    public:
        InvalidTimerAction(char *line);
