...
#ifndef __BACKWARDTRAVERSAL_H__
#define __BACKWARDTRAVERSAL_H__

#include "SafTest.h"
#include "NonEmptyEventLogTestCase.h"

/*****************************************************************************
 * Backward Traversal Test Case
 *****************************************************************************/

namespace ns_saHpiEventLogEntryGet
{
    class BackwardTraversal : public NonEmptyEventLogTestCase
    {
    public:
        BackwardTraversal(char *line);
