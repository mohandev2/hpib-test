...
const char *NoSeverity::getDescription() {
    return "If the <i>AlarmId</i> parameter is passed as SAHPI_ENTRY_UNSPECIFIED, "
           "and no alarms are present that meet the requested <i>Severity</i>, "
           "this function will have no effect.  However, this is not an error.";
}
...
const char *NoSeverity::getPrecondition() {
    return "Requires a severity that isn't being used by any\n"
           "of the alarms in the DAT.";
}
