...
const char *InvalidAlarmId::getDescription() {
    return "The alarm entry identified by the <i>AlarmId</i> parameter\n"
           "does not exist in the DAT.";
}
 ...
 * Run the test.
 *
 * Add an alarm and delete it twice.  On the second delete, the AlarmId
 * is no longer valid and thus we should get NOT PRESENT.
 *****************************************************************************/
