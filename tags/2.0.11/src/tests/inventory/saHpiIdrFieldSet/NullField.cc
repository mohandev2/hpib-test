...
const char *NullField::getDescription() {
    return "The <i>Field</i> pointer is passed in as a NULL.";
}
 ...
 * Run the test.
 *
 * For each area, try setting a field using a NULL Field parameter.
 *****************************************************************************/
...
/*****************************************************************************
 * Try to set a field using a NULL Field parameter.
 *****************************************************************************/

HpiTestStatus NullField::setField(SaHpiSessionIdT sessionId,
                                  SaHpiResourceIdT resourceId, 
                                  SaHpiIdrIdT idrId) {
    HpiTestStatus status;

    SaErrorT error = saHpiIdrFieldSet(sessionId, resourceId, idrId, NULL);
