...
#define TWO_SECONDS  2000000000L

/*****************************************************************************
 * Constructor
 *****************************************************************************/

EventBeforeNormal::EventBeforeNormal(char *line) : SubscribeTestCase(line) {
}
...
const char *EventBeforeNormal::getName() {
    return "EventBeforeNormal";
}
...
const char *EventBeforeNormal::getDescription() {
    return "Add a user event into the event queue and then call\n"
           "saHpiEventGet() with a timeout of one second .  The call\n"
...
SaErrorT EventBeforeNormal::getExpectedReturn() {
    return SA_OK;
}
 ...
 * a timeout of one second.  The call should return immediately.
 *****************************************************************************/

HpiTestStatus EventBeforeNormal::runEventTest(SaHpiSessionIdT sessionId) {
    ...
    if (error != SA_OK) {
        ...
        error = saHpiEventGet(sessionId, TWO_SECONDS,
