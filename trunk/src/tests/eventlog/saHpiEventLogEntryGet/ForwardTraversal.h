...
#ifndef __FORWARDTRAVERSAL_H__
#define __FORWARDTRAVERSAL_H__

#include "SafTest.h"
#include "NonEmptyEventLogTestCase.h"

/*****************************************************************************
 * Forward Traversal Test Case
 *****************************************************************************/

namespace ns_saHpiEventLogEntryGet
{
    class ForwardTraversal : public NonEmptyEventLogTestCase
    {
    public:
        ForwardTraversal(char *line);
