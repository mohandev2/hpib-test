...
#ifndef __ENTRYIDNOTPRESENT_H__
#define __ENTRYIDNOTPRESENT_H__

#include "SafTest.h"
#include "NonEmptyEventLogTestCase.h"

/*****************************************************************************
 * EntryId Not Present Test Case
 *****************************************************************************/

namespace ns_saHpiEventLogEntryGet
{
    class EntryIdNotPresent : public NonEmptyEventLogTestCase
    {
    public:
        EntryIdNotPresent(char *line);
