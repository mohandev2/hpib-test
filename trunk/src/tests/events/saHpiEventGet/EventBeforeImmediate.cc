...
EventBeforeImmediate::EventBeforeImmediate(char *line) : SubscribeTestCase(line) {
}
...
const char *EventBeforeImmediate::getName() {
    return "EventBeforeImmediate";
}
...
const char *EventBeforeImmediate::getDescription() {
    return "Add a user event into the event queue and then call\n"
           "saHpiEventGet() with SAHPI_TIMEOUT_IMMEDIATE.  The call\n"
...
SaErrorT EventBeforeImmediate::getExpectedReturn() {
    return SA_OK;
}
 ...
 * SAHPI_TIMEOUT_IMMEDIATE.  The call should return immediately.
 *****************************************************************************/

HpiTestStatus EventBeforeImmediate::runEventTest(SaHpiSessionIdT sessionId) {
