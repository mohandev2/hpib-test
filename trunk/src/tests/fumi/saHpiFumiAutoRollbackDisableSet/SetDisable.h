...
#ifndef __SETDISABLE_H__
#define __SETDISABLE_H__
...
namespace ns_saHpiFumiAutoRollbackDisableSet
{
    class SetDisable : public FumiTestCase
    {
    public:
        SetDisable(char *line);
    ...
    private:
        HpiTestStatus verifyDisableValue(SaHpiSessionIdT sessionId, 
                                         SaHpiRptEntryT *rptEntry,
                                         SaHpiFumiRecT *fumiRec, 
                                         SaHpiBoolT expValue);
    };
