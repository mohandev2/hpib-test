...
#ifndef __NULLINSTANCEID_H__
#define __NULLINSTANCEID_H__

#include "SafTest.h"
#include "HpiResourceTestCase.h"

/*****************************************************************************
 * NULL InstanceId Test Case
 *****************************************************************************/

namespace ns_saHpiGetIdByEntityPath
{
    class NullInstanceId : public HpiResourceTestCase
    {
    private:
      bool fastExit;

    public:
        NullInstanceId(char *line);
