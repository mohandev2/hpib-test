...
#ifndef __INVALIDINSERTION_H__
#define __INVALIDINSERTION_H__

#include "SafTest.h"
#include "HotSwapTestCase.h"

/*****************************************************************************
 * Invalid Insertion Test Case
 *****************************************************************************/

namespace ns_saHpiHotSwapActionRequest
{
    class InvalidInsertion : public HotSwapTestCase
    {
    public:
        InvalidInsertion(char *line);
