...
#ifndef __SEVERITYTRAVERSAL_H__
#define __SEVERITYTRAVERSAL_H__

#include "AnnunciatorTestCase.h"

/*****************************************************************************
 * Severity Traversal Test Case
 *****************************************************************************/

namespace ns_saHpiAnnunciatorGetNext
{
    class SeverityTraversal : public AnnunciatorTestCase
    {
    public:
        SeverityTraversal(char *line);
