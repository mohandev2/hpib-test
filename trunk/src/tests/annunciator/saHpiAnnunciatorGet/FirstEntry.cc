...
FirstEntry::FirstEntry(char *line) : AnnunciatorTestCase(line) {
    errorList.add(SA_OK);
...
const char *FirstEntry::getDescription() {
    return "Use SAHPI_FIRST_ENTRY as the <i>EntryId</i> to obtain the last\n"
...
HpiTestStatus FirstEntry::runResourceTest(SaHpiSessionIdT sessionId,
