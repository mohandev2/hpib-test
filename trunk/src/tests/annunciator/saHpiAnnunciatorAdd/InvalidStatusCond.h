...
#ifndef __INVALIDSTATUSCOND_H__
#define __INVALIDSTATUSCOND_H__

#include "AnnunciatorTestCase.h"

/*****************************************************************************
 * Invalid StatusCond Test Case
 *****************************************************************************/

namespace ns_saHpiAnnunciatorAdd
{
    class InvalidStatusCond : public AnnunciatorTestCase
    {
    public:
        InvalidStatusCond(char *line);
