...
NullState::NullState(char *line) : PowerTestCase(line) {
}
...
HpiTestStatus NullState::runPowerTest(SaHpiSessionIdT sessionId,
    ...
    if (error == SA_ERR_HPI_INVALID_PARAMS) {
        ...
        status.assertFailure(TRACE, RESOURCE_POWER_STATE_GET,
