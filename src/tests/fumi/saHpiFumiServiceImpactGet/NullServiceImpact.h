...
#ifndef __NULLSERVICEIMPACT_H__
#define __NULLSERVICEIMPACT_H__

#include "SafTest.h"
#include "FumiTestCase.h"

/*****************************************************************************
 * NULL Service Impact Get Test Case
 *****************************************************************************/

namespace ns_saHpiFumiServiceImpactGet
{
    class NullServiceImpact : public FumiTestCase
    {
    public:
        NullServiceImpact(char *line);
