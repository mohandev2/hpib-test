...
#ifndef __INVALIDEXTRACTION_H__
#define __INVALIDEXTRACTION_H__

#include "SafTest.h"
#include "HotSwapTestCase.h"

/*****************************************************************************
 * Invalid Extraction Test Case
 *****************************************************************************/

namespace ns_saHpiHotSwapActionRequest
{
    class InvalidExtraction : public HotSwapTestCase
    {
    public:
        InvalidExtraction(char *line);
