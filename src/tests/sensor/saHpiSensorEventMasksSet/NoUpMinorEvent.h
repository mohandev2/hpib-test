...
#ifndef __NOUPMINOREVENT_H__
#define __NOUPMINOREVENT_H__
...
/*****************************************************************************
 * No UpMinor Event Test Case
 *****************************************************************************/

namespace ns_saHpiSensorEventMasksSet
{
    class NoUpMinorEvent : public HpiSessionTestCase, public EventHandler
    {
    private:
        typedef struct {
