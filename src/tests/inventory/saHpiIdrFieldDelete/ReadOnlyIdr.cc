...
const char *ReadOnlyIdr::getDescription() {
    return "The IDR is read-only and does not allow modifications to its fields.";
}
 ...
 * Run the test.
 *
 * For each area in a read-only IDR, try to delete a field.
 *****************************************************************************/
...
/*****************************************************************************
 * Try to delete a field from an area if the area does have a field.
 *****************************************************************************/

HpiTestStatus ReadOnlyIdr::deleteField(SaHpiSessionIdT sessionId,
